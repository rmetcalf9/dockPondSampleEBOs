...
def getModel(flaskRestPlusAPI):
  ...
  def getTypeModel(flaskRestPlusAPI, typeName):
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:TimeTableEventEBOTypeV1':
      return flaskRestPlusAPI.model('TimeTableEventEBOTypeV1', {
        'Identification': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:IdentificationTypeV1')),
        'EventName': fields.String(default='',description='Descriptipn of the Event'),
        ...
        'Category': fields.String(default='',description='The Event Category classification (Seminar,Lecture, etc.)this needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\TimeTableEvent\V1\XXIC_EventCategory.dvm'),
        #Element GlobalEventFlag has a type that is not catered for (xsd:boolean) 0
        #Element BroadcastFlag has a type that is not catered for (xsd:boolean) 0
        #Element RecordingFlag has a type that is not catered for (xsd:boolean) 0
        'Sessions': fields.Nested(flaskRestPlusAPI.model('InlineSessionsType', {
          'Session': fields.List(fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:SessionTypeV1'))),
        })),

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:RoomTypeV1':
      return flaskRestPlusAPI.model('RoomTypeV1', {
        'RoomInfo': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Space/V1/SpaceRBO:SpaceReferenceTypeV1')),

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:IdentificationTypeV1':
      return flaskRestPlusAPI.model('IdentificationTypeV1', {
        'Code': fields.String(default='',description='Celcat Event ID + TimeTableDB Identifier'),

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:SessionTypeV1':
      return flaskRestPlusAPI.model('SessionTypeV1', {
        #Element Date has a type that is not catered for (xsd:date) 0
        #Element StartTime has a type that is not catered for (xsd:time) 0
        #Element EndTime has a type that is not catered for (xsd:time) 0
        ...
        'Modules': fields.Nested(flaskRestPlusAPI.model('InlineModulesType', {
          'Module': fields.List(fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:ModuleTypeV1'))),
        })),
        'Rooms': fields.Nested(flaskRestPlusAPI.model('InlineRoomsType', {
          'Room': fields.List(fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:RoomTypeV1'))),
        })),

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:ModuleTypeV1':
      return flaskRestPlusAPI.model('ModuleTypeV1', {
        'Identification': fields.Nested(flaskRestPlusAPI.model('InlineIdentificationType', {
          'ModuleUniqueName': fields.String(default='',description='Unique Celcat system name'),
        })),
        'Description': fields.String(default='',description='Module Name'),
        'FolderID': fields.String(default='',description='Folder Id from Panopto'),
  ...
  return flaskRestPlusAPI.model('TimeTableEventEBOV1', {
    'TimeTableEventEBO': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/TimeTableEvent/V1/TimeTableEventEBO:TimeTableEventEBOTypeV1')),
