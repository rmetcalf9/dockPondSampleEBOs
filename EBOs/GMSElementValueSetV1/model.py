...
def getModel(flaskRestPlusAPI):
  ...
  def getTypeModel(flaskRestPlusAPI, typeName):
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/GMSElementValueSet/V1:GMSElementValueSetEBOTypeV1':
      return flaskRestPlusAPI.model('GMSElementValueSetEBOTypeV1', {

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/GMSElementValueSet/V1:GMSElementValueSetLineTypeV1':
      return flaskRestPlusAPI.model('GMSElementValueSetLineTypeV1', {
  ...
  return flaskRestPlusAPI.model('GMSElementValueSetEBOV1', {
    'GMSElementValueSetEBO': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/GMSElementValueSet/V1:GMSElementValueSetEBOTypeV1')),
    'GMSElementValueSetLine': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/GMSElementValueSet/V1:GMSElementValueSetLineTypeV1')),
