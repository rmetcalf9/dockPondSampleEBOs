...
def getModel(flaskRestPlusAPI):
  ...
  return flaskRestPlusAPI.model('PersonEBOV1', {
    'PersonEBO': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Person/V1/PersonEBO:PersonEBOTypeV1')),
