...
def getModel(flaskRestPlusAPI):
  ...
  def getTypeModel(flaskRestPlusAPI, typeName):
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Student/V1/StudentEBO:StudentEBOTypeV1':
      return flaskRestPlusAPI.model('StudentEBOTypeV1', {
        ...
        'StudentSupervisors': fields.Nested(flaskRestPlusAPI.model('InlineStudentSupervisorsType', {
          'StudentSupervisor': fields.Nested(flaskRestPlusAPI.model('InlineStudentSupervisorType', {
            'Identification': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Person/V1/PersonEBO:IdentificationTypeV1')),
            'Name': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Person/V1/PersonEBO:PersonNameTypeV1')),
            'ElectronicAddresses': fields.Nested(flaskRestPlusAPI.model('InlineElectronicAddressesType', {
              'ElectronicAddress': fields.List(fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_CBO/V1/ElectronicAddressType:ElectronicAddressTypeV1'))),
            })),
            'SupervisorType': fields.String(default='',description='This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\Student\V1\XXIC_StudentSupervisorType.dvm'),
          })),
        })),
        'StudentProgrammeVersions': fields.Nested(flaskRestPlusAPI.model('InlineStudentProgrammeVersionsType', {
          'StudentProgrammeVersion': fields.List(fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Student/V1/StudentEBO:StudentProgrammeVersionTypeV1'))),
        })),
    ...
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Student/V1/StudentEBO:StudentProgrammeVersionTypeV1':
      return flaskRestPlusAPI.model('StudentProgrammeVersionTypeV1', {
        'Programme': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Student/V1/StudentEBO:ProgrammeTypeV1')),
        ...
        #Element DiscontinuedDate has a type that is not catered for (xsd:dateTime) 0
        #Element ExpectedDateofReturn has a type that is not catered for (xsd:dateTime) 0
        'Active': fields.String(default='',description='This indicates if the student is active student or not'),
        'ProgrammeResult': fields.String(default='',description='This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\Student\V1\XXIC_StudentProgrammeResult.dvm'),
        ...
        'CurrentCohortYear': fields.String(default='',description='A class of students e.g Class of 2004'),
        'OriginalCohortYear': fields.String(default='',description='A class of students e.g Class of 2004'),
        ...
        'StudentEnrollmentCode': fields.String(default='',description='This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\Student\V1\XXIC_StudentEnrollmentCode.dvm'),
        ...
        #Element IntegrateWithTutoringSystem has a type that is not catered for (xsd:boolean) 0
        ...
        #Element ThesisSubmissionDueDate has a type that is not catered for (xsd:date) 0
        #Element ConferralDate has a type that is not catered for (xsd:date) 0
        'WritingUp': fields.String(default='',description='This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\Student\V1\XXIC_WritingUp.dvm'),
        'InterruptionReason': fields.String(default='',description='This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\Student\V1\XXIC_InterruptionReason.dvm'),

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Student/V1/StudentEBO:ProgrammeTypeV1':
      return flaskRestPlusAPI.model('ProgrammeTypeV1', {
        ...
        'Department': fields.Nested(flaskRestPlusAPI.model('InlineDepartmentType', {
          'Code': fields.String(default='',description='Department code of where the student is affiliated'),
          'Name': fields.String(default='',description='Department name of where the student is affiliated'),
        })),
  ...
  return flaskRestPlusAPI.model('StudentEBOV1', {
    'StudentEBO': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/Student/V1/StudentEBO:StudentEBOTypeV1')),
