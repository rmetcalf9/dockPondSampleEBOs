...
def getModel(flaskRestPlusAPI):
  ...
  def getTypeModel(flaskRestPlusAPI, typeName):
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/CustOrganization/V1/CustOrganizationEBO:IdentificationTypeV1':
      return flaskRestPlusAPI.model('IdentificationTypeV1', {
        'CID': fields.String(default='',description='College CID for the organization'),

      })
    if typeName=='http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/CustOrganization/V1/CustOrganizationEBO:CustOrganizationEBOTypeV1':
      return flaskRestPlusAPI.model('CustOrganizationEBOTypeV1', {
        'Identification': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/CustOrganization/V1/CustOrganizationEBO:IdentificationTypeV1')),
        'Name': fields.String(default='',description='Name of the Organization'),
        ...
        'CategoryCode': fields.String(default='',description='Category Code of the Organization e.g Corporate, Consumer This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_EBO\CustOrganization\V1\XXIC_CustomerCategoryCode.dvm'),
        'Status': fields.String(default='',description='Cust Organization Status e.g Active, Inactive The DVM is from the same source as the DVM used by CustPerson This needs to match one of the values from this dvm - AIAMetaData\AIAComponents\EnterpriseObjectLibrary\Core\IC_CBO\V1\XXIC_PartyStatus.dvm'),
  ...
  return flaskRestPlusAPI.model('CustOrganizationEBOV1', {
    'CustOrganizationEBO': fields.Nested(getTypeModel(flaskRestPlusAPI, 'http://ic.ac.uk/AIAMetaData/AIAComponents/EnterpriseObjectLibrary/Core/IC_EBO/CustOrganization/V1/CustOrganizationEBO:CustOrganizationEBOTypeV1')),
